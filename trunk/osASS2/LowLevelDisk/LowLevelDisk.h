 ...
 */
string getInodeType(int i-node);
/*
 * set the type of the file (normal/directory/soft-link).
 */
void setInodeType(int i-node, filetype);
/*
 ...
 */
int getDataBlock (int i-node, int i);
/*
 * sets the i-th data block of this file to be dblockNum.
 */
void setDataBlock (int i-node, int i, int dblockNum );
/*
 ...
 */
int getFileSize(int i-node);
/*
 * set the file size.
 */
void setFileSize(int i-node, int newSize);
/*
 *
 */
...
(for example: requesting to free an i-node that was not allocated,
 requesting to allocate an i-node when there are none free, asking for the file name of a free i-node, asking the 34th data block of a file that contains only 30 data blocks, etc.).*/
